...
//
using System;
using RoSatGCS.Utils.Satellites.Propagation;
...
namespace RoSatGCS.Utils.Satellites.Observation
{
    ...
    public class Satellite
    {
        ...
        public Satellite(TLE.TLE tle, string? name = null)
        {
            Orbit = new Orbit(tle.OrbitalElements);
        ...
        public EciCoordinate PositionEci()
        {
            return Orbit.PositionEci(DateTime.UtcNow);
        }

        public EciCoordinate PositionEci(Julian time)
        {
            return Orbit.PositionEci(time.ToTime());
        }
        ...
        /// <returns>The ECI location of the satellite at the given time.</returns>
        public EciCoordinate PositionEci(double mpe)
        {
