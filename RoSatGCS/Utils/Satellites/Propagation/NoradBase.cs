...
namespace RoSatGCS.Utils.Satellites.Propagation
{
	...
	abstract internal class NoradBase
   {
      ...
      private void Initialize()
      {
         ...
         m_satInc = Orbit.Elements.InclinationRad;
         m_satEcc = Orbit.Elements.Eccentricity;
         ...
         m_aodp  = Orbit.SemiMajorRec;
         m_xnodp = Orbit.MeanMotionRec;
         ...
         m_c4     = 2.0 * m_xnodp * m_coef1 * m_aodp * m_betao2 * 
                    ...
                    Math.Cos(2.0 * Orbit.Elements.ArgPerigeeRad)));
