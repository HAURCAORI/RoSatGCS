...
const uint8_t* u8vector_elements(pmt_t v, size_t& len);   //< len is in elements
const int8_t* s8vector_elements(pmt_t v, size_t& len);    //< len is in elements
const uint16_t* u16vector_elements(pmt_t v, size_t& len); //< len is in elements
const int16_t* s16vector_elements(pmt_t v, size_t& len);  //< len is in elements
const uint32_t* u32vector_elements(pmt_t v, size_t& len); //< len is in elements
const int32_t* s32vector_elements(pmt_t v, size_t& len);  //< len is in elements
const uint64_t* u64vector_elements(pmt_t v, size_t& len); //< len is in elements
const int64_t* s64vector_elements(pmt_t v, size_t& len);  //< len is in elements
const float* f32vector_elements(pmt_t v, size_t& len);    //< len is in elements
const double* f64vector_elements(pmt_t v, size_t& len);   //< len is in elements
const std::complex<float>* c32vector_elements(pmt_t v,
...
const std::vector<uint64_t> u64vector_elements(pmt_t v);
const std::vector<int64_t> s64vector_elements(pmt_t v);
...
uint8_t* u8vector_writable_elements(pmt_t v, size_t& len); //< len is in elements
int8_t* s8vector_writable_elements(pmt_t v, size_t& len);  //< len is in elements
uint16_t* u16vector_writable_elements(pmt_t v,
                                              size_t& len);         //< len is in elements
int16_t* s16vector_writable_elements(pmt_t v, size_t& len); //< len is in elements
uint32_t* u32vector_writable_elements(pmt_t v,
                                              size_t& len);         //< len is in elements
int32_t* s32vector_writable_elements(pmt_t v, size_t& len); //< len is in elements
uint64_t* u64vector_writable_elements(pmt_t v,
                                              size_t& len);         //< len is in elements
int64_t* s64vector_writable_elements(pmt_t v, size_t& len); //< len is in elements
float* f32vector_writable_elements(pmt_t v, size_t& len);   //< len is in elements
double* f64vector_writable_elements(pmt_t v, size_t& len);  //< len is in elements
std::complex<float>*
